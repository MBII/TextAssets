...
models/players/stormie/armor_leg_commander
{
	{
		map models/players/stormie/armor_leg_commander
		rgbGen lightingDiffuse
	}
	{
		map models/players/phasma/gloss
...
models/players/stormie/armor_leg_private
{
	{
		map models/players/stormie/armor_leg_private
		rgbGen lightingDiffuse
	}
	{
		map models/players/phasma/gloss
...
models/players/stormie/armor_commander
{
	{
		map models/players/stormie/armor_commander
		rgbGen lightingDiffuse
	}
	{
		map models/players/phasma/gloss
	...
	}
	{
 	...
 	{
        map models/players/stormie/armor_spec2
       	blendFunc GL_SRC_ALPHA GL_ONE
      	detail
       	alphaGen lightingSpecular
	}
...
models/players/stormie/armor_private
{
	{
		map models/players/stormie/armor_private
		rgbGen lightingDiffuse
	}
	{
		map models/players/phasma/gloss
...
models/players/stormie/armor_tiber_saxon
{
	{
		map models/players/stormie/armor_tiber_saxon
		rgbGen lightingDiffuse
	}
	{
		map models/players/phasma/gloss
...
models/players/stormie/gear_jet
{
	cull twosided
	{
		map models/players/stormie/gear_jet
		rgbGen lightingDiffuse
	}
 	{
		map models/players/stormie/gear_jet_spec
		blendFunc GL_SRC_ALPHA GL_ONE
		detail
		alphaGen lightingSpecular
	}
...
models/players/stormie/gear_jetpack
{
	{
		map models/players/stormie/gear_jetpack
		rgbGen lightingDiffuse
	}
 	{
		map models/players/stormie/gear_jetpack
    ...
    {
		map models/players/stormie/gear_jetpack_glow
