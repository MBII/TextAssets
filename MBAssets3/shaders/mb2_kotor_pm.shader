...
models/players/bastila_sith/robe
{
	cull	twosided
	{
		map models/players/bastila_sith/robe
		rgbGen lightingDiffuse
	}
}

models/players/bastila_sith/hairtie_sith
{
	{
		map models/players/bastila_sith/hairtie_sith
		rgbGen lightingDiffuse
	}
	{
		map models/players/bastila/hairtie_spec
...
models/players/bastila_sith/hair_goth
{
	cull	twosided
	{
		map models/players/bastila_sith/hair_goth
		alphaFunc GE128
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		depthWrite
		rgbGen lightingDiffuse
...
models/players/bastila_sith/hair_sith
{
	cull	twosided
	{
		map models/players/bastila_sith/hair_sith
		alphaFunc GE128
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		depthWrite
		rgbGen lightingDiffuse
