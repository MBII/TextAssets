...
// Sith Eradicator - Aviar

models/players/jedi_tor/head_face_aviar
{
	{
		map models/players/jedi_tor/head_face_aviar
		rgbGen lightingDiffuse
	}
	{
		map models/players/jedi_tor/head_face_aviar-spec
		blendFunc GL_SRC_ALPHA GL_ONE
		alphaGen lightingSpecular
		detail
	}
...
models/players/jedi_tor/hood_sith_cull
{
	cull	twosided
    {
        map models/players/jedi_tor/hood_sith
        rgbGen lightingDiffuse
    }
}