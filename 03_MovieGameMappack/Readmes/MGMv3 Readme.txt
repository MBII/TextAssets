...
Based on the second Aliens movie on LV426 Hadley's Hope colony.

Credits - Map: Plasma
          FA: Alpha, Plasma
          Textures: Jockum Skoglund aka hipshot
          Skins: Alpha
          Models: Jora Custov, Lervish, Fox(c)

:--DC Universe--:

Set in Gotham pick a hero or villain from the DC Universe and fight it out.

Credits - Map: Plasma
          FA: Plasma
          Textures: Plasma, Valve, Blackrayne Studios
          Skins: NetherRealm Studios, Aidy, Potatochimp, Inyri Forge, Lord Suibuku, C.Black, Rapp_scallion, Chryonic, DDROM, Sanj, phonock, Malvin Zuroff
          Models: Lightsource, Mars Marshall, P.Alexandru, Graves, Major Clod, Jora Custov, Shady-D

:--FIFA--:

Port of my futbol map from the 2010 World Cup, updated with Arsenal and Real Madrid and now set at night.

Credits - Map: Plasma, Mace
	  FA: Plasma
	  Models: IOS Source, Lervish

:--FY Poolday--:

Port of my CMP map Poolday with a new CSS themed FA.

Credits - Map: Plasma
	  FA: Plasma
	  Skins: RJK Jack O'Neil(Ki_Adi), Tobe One, Imortality, stealthsilver, d0nn
	  Models: Valve, Lt. Claim
...
Based on the Halo multiplayer map Beaver/Battle Creek, you play assault mode on team defends while the other has to plant a bomb in the enemy base.

Credits - Map: Plasma
          FA: Plasma
          Models: Graves, Twingo, AgentJ64, Bungie, Microsoft
          Skins: H2CE Team

:--Lego Star Wars--:

A de_rats styled map with the FA based on Lego Star Wars.
...
Stylised to look like the VR missions in Metal Gear Solid has characters from different Metal Gear Solid games fight each other.

Credits - Map: Plasma
          Textures: Darth NormaN
          FA: Plasma
          Models: tylerkilbourne, IFailedEnglish, Hapslash, Graves, Darth Kitty, Revan Dark, Tyrael64

:--Monster Forest--:

An alt FA for the slender map that pits survivors against zombies and werewolves.

Credits - Map: Plasma
          FA: Plasma
          Models: Shady-D, Blackrayne Studios

:--Pokemon--:

Set in Pallet Town and Viridian City, I had to cut certain sections because of the FPS.

Credits - Map: Plasma
          FA: Plasma
          Models: Plasma, Lervish, Nintendo

:--Resident Evil Mansion--:

Based on the first Resident Evil game in the mansion.

Credits - Map: Plasma
          FA: Plasma
          Models: Darth Tempust, ashuradx, Noen Garuth, Lightsource
...
Credits - Map: Plasma
          Textures: Jockum Skoglund aka hipshot
          Models: Raven Software, Blackrayne Studios, Oobah, Jimesu_Evil, Satansmaster, Playingkarrde, Shady-D, Chryonic, HOUOU, WK Baldwin "Cable"

:--Slender--:

Based on the Unity game Slender: The Eight Pages.

Credits - Map: Plasma
          FA: Plasma
          Models: Blackrayne Studios, GrimReaper, IO Interactive, MaxFreeman
          Skins: Mars Ultor, Inyri Forge, Tyrael64, Lady Trinity, Cloud_guy
          Textures: AgentParsec
          
:--Ultimate Showdown--:

An alt FA for the dc universe map that adds a bunch of characters from different FAs.

Credits - Map: Plasma
          FA: Plasma
          Models: Antizac, Szico VII, ORiON, AshuraDX, MaxFreeman, ArchAngel, Psyk0Sith
          Skins: Tim "The Geek" Underbakke, Akim G. B., Lucas, AsianLucas
...
Credits - Map: Darth.Hunter
	  FA: Plasma
	  Skins: RJK Jack O'Neil(Ki_Adi), Tobe One
	  Models: Valve
